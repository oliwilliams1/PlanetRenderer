...
int main() {
	...
	Planet mainPlanet = Planet(&planetShader, noiseGen.cubemapNoiseTexture, noiseGen.cubemapNormalTexture); // Shaders must be generated sequentially with no other calls inbetween
